...
if __name__ == "__main__":
    root, steps, table, graph, iterations = bisection_method(func, 0, 3, significant_figures=15, error=1e-10, max_iterations=200)
    graph.show()
    print(steps)
    print(table)
    print("By bisection, root = ", root, " in", iterations, " iterations")

    root, steps, table, graph, iterations = false_position_method(func, 0, 3, significant_figures=15, error=1e-10, max_iterations=200)
    graph.show()
    print(steps)
    print(table)
